...
(defclass by-name-id ()
  ((by-name :reader by-name :initform (make-hash-table :test equalp))
   (by-id :reader by-id :initform (make-hash-table :test equalp))))
...
(defclass tags-component (query-component)
  ((tags :reader tags :initarg :tags)
   (filter-as :reader filter-as :initarg :filter-as)))
...
(defgeneric evaluate-component (eval-context component &optional oids))


(defmethod evaluate-component (eval-context (component class-component) &optional oids))
(defmethod evaluate-component (eval-context (component groups-component) &optional oids))
(defmethod evaluate-component (eval-context (component tags-component) &optional oids))
(defmethod evaluate-component (eval-context (component related-component) &optional oids))
(defmethod evaluate-component (eval-context (component attribute-component) &optional oids))
(defmethod evaluate-component (eval-context (component and-component) &optional oids))

(defmethod evaluate-component (eval-context (component or-component) &optional oids)
